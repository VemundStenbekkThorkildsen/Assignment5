...
These conditions make it possible to express $b_1$ and $b_2$, by $b_3$:\\
...
These relations have been used to find $b-$ and $c$-values.
...
\end{bmatrix}$\\
\vspace{0.5cm}
We can now use the last boundary:
$T_3(-120)=1300$
to find $b_3$, henceforth giving us the values for $b$:\\
\vspace{0.5cm}
$b=\begin{bmatrix}
-29\\
-20.6\\
