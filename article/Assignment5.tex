...
\begin{figure}[H]
 	\centering
  	\subfigure[\ $t_1$]{\includegraphics[width = 0.49\textwidth]{../plots/t2.pdf}}  
  	\subfigure[\ $t_2$]{\includegraphics[width = 0.49\textwidth]{../plots/t1.pdf}}
...
\noindent The boundary conditions in the two dimensional case is depending on what kind of system being simulated. If the system in question is a two dimensional rod with a heat source at one end and heat loss at all the other edges, the temperature distribution would look like $enfigurejegikkehar$. If the system is simulating the temperature distribution in the lithosphere, it is not expected to be much heat loss in the lateral direction. 
\\

\noindent The last case looked on is the three layered lithosphere model. The two bottom layers are enriched with a radioactive substance that alters the heat production in the layer. The enriched area is limited to 150 kilometers of lateral extension. As the area is limited, there will be heat flow in horizontal direction.  
