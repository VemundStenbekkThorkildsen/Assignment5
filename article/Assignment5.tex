...
\end{bmatrix}
\end{equation}
These values have been used in combination with equation $robinergay2$ to plot the analytic temperature distribution for the three layered lithosphere model without enrichment $(a_1,b_1,c_1)$(\ref{10analyticNotEnriched}) and with enrichment $(a_2,b_2,c_2)$(\ref{10analyticEnriched}). 
